...
standTwo.addEventListener("click", function () {
  ...
  aboutStand.innerText =
    "Данный стенд разработан с целью детального изучения стандарта 802.11. Включает в себя различные типы антенн, вендоров сетевого оборудования и проприетарные технологии в рамках единого решения." +
    "\r\n" +
    "\r\n" +
...
standThree.addEventListener("click", function () {
  ...
  aboutStand.innerText =
    "Данный стенд позволяет на своей базе выполнять огромное количество функций и сценариев, вот некоторые из них:" +
    "\r\n" +
    "\r\n" +
